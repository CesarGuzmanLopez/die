...
(function () {
  ...
  let slidercesar = function (slidercesarSlides) {
    ...
    slidercesarSlider.forEach(function (slider, index) {
      let initialActiveSlideAttr = slider.getAttribute("data-initial-active-slide");
      ...
      let transitionDurationAttr = slider.getAttribute("data-transition-duration");
      ...
      let el_slidercesar__slides = slider.querySelectorAll(".slidercesar__slide");
      let el_slidercesar__button__previous = slider.querySelector(".slidercesar__button__previous");
      let el_slidercesar__button__next = slider.querySelector(".slidercesar__button__next");
      el_slidercesar__track.addEventListener("transitionstart", transitionStart);
      ...
      let parallaxSlides = slider.querySelectorAll('.slidercesar__slide[data-parallax="true"]');
      if (parallaxSlides) {
        parallaxInit();
        window.addEventListener("scroll", function (event) {
          parallaxSlides.forEach(function (parallaxSlide, index) {
            ...
            let el_slide_bg = parallaxSlide.querySelectorAll(".slidercesar__slide__bg")[0];
            if (parallaxAttribute) {
              ...
              if (sliderPositionY <= window.innerHeight && sliderPositionY >= Math.abs(window.innerHeight) * -1) {
                let parallaxSpeed = parallaxAttribute ? parseInt(parallaxAttribute) / 100 : 0;
      ...
      function parallaxInit() {
        parallaxSlides.forEach(function (slide, index) {
          ...
          let el_slide_bg = slide.querySelectorAll(".slidercesar__slide__bg")[0];
      ...
      let el_slidercesar__buttons = slider.querySelectorAll(".slidercesar__button");
      if (settings.slideNavigation != "none") {
        el_slidercesar__buttons.forEach(function (button) {
          button.addEventListener("click", function () {
            if (!animating) {
              let buttonIdValue = parseInt(button.getAttribute("data-button-id"));
      ...
      function animateTrackToSlideId(slideId, toggleAutoplay) {
        ...
        if (!animating) {
          ...
          if (currentSlideId != slideId) {
            el_slidercesar__slides = slider.querySelectorAll(".slidercesar__slide");
            let slideIndex_1 = slideId;
            if (!settings.loopSlide) {} else if (settings.transitionEffect == "slide" && settings.loopSlide == true) {
              if (currentSlideIndex === 0 && el_slidercesar__slides.length > 2) {
                el_slidercesar__track.style.transition = "none";
                let lastSide = el_slidercesar__slides[el_slidercesar__slides.length - 1];
              ...
              } else if (currentSlideIndex === el_slidercesar__slides.length - 1) {
                el_slidercesar__track.style.transition = "none";
              ...
              let slideMatch = slider.querySelectorAll('[data-slide-index="' + slideId + '"]');
              if (slideMatch[0] && slideMatch[0].parentNode) {
                let slideMatch_parent_children = slideMatch[0].parentNode.children;
      ...
      function animate(slideId, slideIndex) {
        if (settings.transitionEffect == "slide") {
          el_slidercesar__track.style.transition = "all " + settings.transitionDuration + " " + settings.animation;
      ...
      function transitionStart() {
        ...
        slider.querySelector('[data-slide-index="' + currentSlideId + '"]').classList.add("slidercesar__slide--animating-in");
        slider.querySelector('[data-slide-index="' + previousSlideId + '"]').classList.add("slidercesar__slide--animating-out");
      }
      function transitionEnd() {
        slider.querySelector(".slidercesar__slide--active").classList.remove("slidercesar__slide--active");
        slider.querySelector('[data-slide-index="' + currentSlideId + '"]').classList.add("slidercesar__slide--active");
        if (settings.slideNavigation != "none") {
          slider.querySelector(".slidercesar__button--active").classList.remove("slidercesar__button--active");
          el_slidercesar__buttons[currentSlideId].classList.add("slidercesar__button--active");
        }
        animating = false;
      ...
      function removeAnimatingClasses() {
        slider.querySelector('[data-slide-index="' + currentSlideId + '"]').classList.remove("slidercesar__slide--animating-in");
        slider.querySelector('[data-slide-index="' + previousSlideId + '"]').classList.remove("slidercesar__slide--animating-out");
      }
      if (settings.variableHeight) {
      ...
      function updateSliderHeight() {
        ...
        let currentImage = slider.querySelector('[data-slide-index="' + currentSlideId + '"] img.visible--' + currentSceenSize);
        if (currentImage) {
...
/******/ })()
;
//# sourceMappingURL=slider-cesar.js.map