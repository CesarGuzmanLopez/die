...
if ( ! class_exists( 'CtemaWP_Sensei' ) ) :

	class CtemaWP_Sensei {
		...
		public static function add_custom_css() {
			if ( is_sensei() || is_tax( 'module' ) ) {
				wp_enqueue_style( 'ctemawp-sensei', CTEMAWP_CSS_DIR_URI .'third/sensei.min.css' );
			}
		}
		...
		public static function wrapper_start() {
			...
			<div id="content-wrap" class="container ctemawp-sensei clr">
