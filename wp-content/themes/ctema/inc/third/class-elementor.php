...
if ( ! class_exists( 'CtemaWP_Elementor' ) ) :

	class CtemaWP_Elementor {
		...
		public static function get_topbar_content_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_top_bar_template' );
		...
		public static function get_topbar_social_alt_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_top_bar_social_alt_template' );
		...
		public static function get_vertical_header_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_vertical_header_template' );
		...
		public static function get_vertical_header_bottom_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_vertical_header_bottom_template' );
		...
		public static function get_header_id() {
			...
			// Template
			$id = ctemawp_custom_header_template();
		...
		public static function get_nav_id() {
			...
			// Template
			$id = ctemawp_custom_nav_template();
		...
		public static function get_social_menu_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_menu_social_template' );
		...
		public static function get_footer_id() {
			...
			// Template
			$id = ctemawp_custom_footer_template();
		...
		public static function get_error_page_id() {
			...
			// Template
			$id = get_theme_mod( 'ctema_error_page_template' );
		...
		public static function preview_styles() {
			wp_enqueue_style( 'ctemawp-elementor-preview', CTEMAWP_CSS_DIR_URI .'third/elementor-editor.min.css' );
		}
