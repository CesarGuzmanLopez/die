...
if ( ! class_exists( 'Ctemawp_Plugin_Manager' ) ) {

	class Ctemawp_Plugin_Manager {


		public function __construct() {         }

		public function get_ctema_extra_status() {
			$free_status = $this->get_plugin_status( 'ctema-extra' );
		...
		protected function require_wp_headers() {
			...
			if ( ! class_exists( 'Ctemawp_Upgrader_Skin', false ) ) {
				require_once dirname( __FILE__ ) . '/class-ctemawp-upgrader-skin.php';
			}
		}
		...
		public function download_and_install( $slug ) {
			...
			$skin = new Ctemawp_Upgrader_Skin();
