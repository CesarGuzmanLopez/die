...
( function( $ ) {
	...
	api( 'ctema_ld_global_both_sidebars_content_width', function( value ) {
		value.bind( function( to ) {
			var $child = $( '.customizer-ctema_ld_global_both_sidebars_content_width' );
			if ( to ) {
				var style = '<style class="customizer-ctema_ld_global_both_sidebars_content_width">@media only screen and (min-width: 960px){ body.ld-global-layout.content-both-sidebars .content-area { width: ' + to + '%; } body.ld-global-layout.content-both-sidebars.scs-style .widget-area.sidebar-secondary, body.ld-global-layout.content-both-sidebars.ssc-style .widget-area {left: -' + to + '%;} }</style>';
				if ( $child.length ) {
	...
	api( 'ctema_ld_global_both_sidebars_sidebars_width', function( value ) {
		value.bind( function( to ) {
			var $child = $( '.customizer-ctema_ld_global_both_sidebars_sidebars_width' );
			if ( to ) {
				var style = '<style class="customizer-ctema_ld_global_both_sidebars_sidebars_width">@media only screen and (min-width: 960px){ body.ld-global-layout.content-both-sidebars .widget-area{width:' + to + '%;} body.ld-global-layout.content-both-sidebars.scs-style .content-area{left:' + to + '%;} body.ld-global-layout.content-both-sidebars.ssc-style .content-area{left:'+ to * 2 +'%;} }</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'ctema_ld_course_both_sidebars_sidebars_width', function( value ) {
		value.bind( function( to ) {
			var $child = $( '.customizer-ctema_ld_course_both_sidebars_sidebars_width' );
			if ( to ) {
				var style = '<style class="customizer-ctema_ld_course_both_sidebars_sidebars_width">@media only screen and (min-width: 960px){ body.single-course.content-both-sidebars .widget-area{width:' + to + '%;} body.single-course.content-both-sidebars.scs-style .content-area{left:' + to + '%;} body.single-course.content-both-sidebars.ssc-style .content-area{left:'+ to * 2 +'%;} }</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'ctema_ld_lesson_both_sidebars_content_width', function( value ) {
		value.bind( function( to ) {
			var $child = $( '.customizer-ctema_ld_lesson_both_sidebars_content_width' );
			if ( to ) {
				var style = '<style class="customizer-ctema_ld_lesson_both_sidebars_content_width">@media only screen and (min-width: 960px){ body.single-lesson.content-both-sidebars .content-area { width: ' + to + '%; } body.single-lesson.content-both-sidebars.scs-style .widget-area.sidebar-secondary, body.single-lesson.content-both-sidebars.ssc-style .widget-area {left: -' + to + '%;} }</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'ctema_ld_lesson_both_sidebars_sidebars_width', function( value ) {
		value.bind( function( to ) {
			var $child = $( '.customizer-ctema_ld_lesson_both_sidebars_sidebars_width' );
			if ( to ) {
				var style = '<style class="customizer-ctema_ld_lesson_both_sidebars_sidebars_width">@media only screen and (min-width: 960px){ body.single-lesson.content-both-sidebars .widget-area{width:' + to + '%;} body.single-lesson.content-both-sidebars.scs-style .content-area{left:' + to + '%;} body.single-lesson.content-both-sidebars.ssc-style .content-area{left:'+ to * 2 +'%;} }</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	}), api("ctema_ld_heading_color", function($swipe) {
	...
	}), api("ctema_ld_heading_bg_color", function($swipe) {
		$swipe.bind(function(size) {
	...
	}), api("ctema_ld_item_color", function($swipe) {
		$swipe.bind(function(size) {
	...
	}), api("ctema_ld_complete_color", function($swipe) {
		$swipe.bind(function(size) {
	...
	}), api("ctema_ld_incomplete_color", function($swipe) {
		$swipe.bind(function(size) {
	...
	}), api("ctema_ld_progressbar_color", function($swipe) {
		$swipe.bind(function(size) {
