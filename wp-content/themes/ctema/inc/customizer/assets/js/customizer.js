jQuery(document).on('ctemaready', function() {
	var $ = jQuery;
	"use strict";
	...
	$('.sortable_repeater_control:not(.ctema-proccessed)').each(function() {
		$(this).addClass('ctema-proccessed');
	...
	$(this).find('.sortable_repeater.sortable:not(.ctema-proccessed)').sortable({
		update: function(event, ui) {
			skyrocketGetAllInputs($(this).parent());
		}
	});

	$(this).find('.sortable_repeater.sortable:not(.ctema-proccessed)').addClass('ctema-proccessed');


	// Remove item starting from it's parent element
	$('.sortable_repeater.sortable:not(.ctema-proccessed)').on('click', '.customize-control-sortable-repeater-delete', function(event) {
		$(this).addClass('ctema-proccessed');
	...
	// Add new item
	$('.customize-control-sortable-repeater-add:not(.ctema-proccessed)').click(function(event) {
		$(this).addClass('ctema-proccessed');
		event.preventDefault();
	...
	$('.sortable_repeater.sortable:not(.ctema-proccessed)').change(function() {
		$(this).addClass('ctema-proccessed');
		skyrocketGetAllInputs($(this).parent());
	})

	// Add https:// to the start of the URL if it doesn't have it
	$('.sortable_repeater.sortable:not(.ctema-proccessed)').on('blur', '.repeater-input', function() {
		$(this).addClass('ctema-proccessed');
		var url = $(this);
		var val = url.val();
		if (val && !val.match(/^.+:\/\/.*/)) {
	...
	$('.slider-custom-control:not(.ctema-proccessed)').each(function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.slider:not(.ctema-proccessed)').on('slide', function(event, ui) {
		$(this).addClass('ctema-proccessed');
		$(this).parent().find('.customize-control-slider-value').val(ui.value);
	});

	// Reset slider and input field back to the default value
	$('.slider-reset:not(.ctema-proccessed)').on('click', function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.single-accordion-toggle:not(.ctema-proccessed)').click(function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.multi-image-checkbox:not(.ctema-proccessed)').on('change', function() {
		$(this).addClass('ctema-proccessed');
	...
	$(".pill_checkbox_control .sortable:not(.ctema-proccessed)").sortable({
		placeholder: "pill-ui-state-highlight",
		update: function(event, ui) {
			skyrocketGetAllPillCheckboxes($(this).parent());
		}
	});
	$(".pill_checkbox_control .sortable:not(.ctema-proccessed)").addClass('ctema-proccessed');

	$('.pill_checkbox_control .sortable-pill-checkbox:not(.ctema-proccessed)').on('change', function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.customize-control-dropdown-select2:not(.ctema-proccessed)').each(function() {
		$(this).addClass('ctema-proccessed');
	...
	$(".customize-control-select2:not(.ctema-proccessed)").on("change", function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.google-fonts-list:not(.ctema-proccessed)').each(function(i, obj) {
		$(this).addClass('ctema-proccessed');
	...
	$('.google-fonts-list:not(.ctema-proccessed)').on('change', function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.google_fonts_select_control select:not(.ctema-proccessed)').on('change', function() {
		$(this).addClass('ctema-proccessed');
		skyrocketGetAllSelects($(this).parent().parent());
	});
	...
	$('.customize-control-tinymce-editor:not(.ctema-proccessed)').each(function() {
		$(this).addClass('ctema-proccessed');
	...
	$('.wpcolorpicker-alpha-color-picker:not(.ctema-proccessed)').each(function(i, obj) {
		$(this).addClass('ctema-proccessed');
	...
	$('.alpha-color-control:not(.ctema-proccessed)').each(function() {
		...
		colorPickerOptions = {
			...
			palettes: ctemawpLocalize.colorPalettes // Use the passed in palette.
		};
