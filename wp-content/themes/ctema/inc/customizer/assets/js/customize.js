    ...
    wp.customize.bind('ready', function() {
        ...
        api.section.each( function( section ) {
            section.container.bind( 'expanded', function() {
                ...
                if ( added ) {
                    jQuery( document ).trigger('ctemaready');
                }
            } )
        } )
        ...
        wp.customize.previewer.bind('url',function(to) {
            localStorage.setItem( 'CtemaCustomizePreviewUrl', to );
        })

        if ( localStorage.getItem( 'CtemaCustomizePreviewUrl' ) ) {
            wp.customize.previewer.previewUrl( localStorage.getItem( 'CtemaCustomizePreviewUrl' ) );
            localStorage.removeItem( 'CtemaCustomizePreviewUrl' );
        }
    })
