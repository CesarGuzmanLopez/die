...
if ( ! class_exists( 'CtemaWP_LearnDash_Customizer' ) ) :

	/**
	 * Settings for general options
	 */
	class CtemaWP_LearnDash_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			 ...
			 * Panel
			 */
			$panel = 'ctema_ld_panel';
			$wp_customize->add_panel(
				$panel,
				array(
					'title'    => esc_html__( 'LearnDash', 'ctemawp' ),
					'priority' => 210,
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_distraction_free_learning',
				array(
					'default'           => false,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'     => 'checkbox',
						'section'  => 'ctema_ld_general',
						'settings' => 'ctema_ld_distraction_free_learning',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Radio_Image_Control(
					...
					array(
						...
						'section'  => 'ctema_ld_layout',
						'settings' => 'ctema_ld_global_layout',
						'priority' => 10,
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_global_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'ctemawp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_global_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
						...
						'active_callback' => 'ctemawp_cac_has_ld_global_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_global_both_sidebars_content_width',
				array(
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_global_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_global_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'ctemawp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_global_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'ctemawp' ),
						'section'  => 'ctema_ld_layout',
						'settings' => 'ctema_ld_course_layout',
						'priority' => 10,
						'choices'  => ctemawp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_course_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'ctemawp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_course_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'ctemawp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'ctemawp' ),
						...
						'active_callback' => 'ctemawp_cac_has_ld_course_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_course_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'ctemawp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_course_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_course_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'ctemawp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_course_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_course_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'ctemawp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'ctemawp' ),
						),
						'active_callback' => 'ctemawp_cac_has_ld_course_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Heading_Control(
					...
					'ctema_ld_lesson_heading',
					array(
						'label'    => esc_html__( 'Lesson/Topic', 'ctemawp' ),
						'section'  => 'ctema_ld_layout',
						'priority' => 10,
					)
				)
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'ctemawp' ),
						'section'  => 'ctema_ld_layout',
						'settings' => 'ctema_ld_lesson_layout',
						'priority' => 10,
						'choices'  => ctemawp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_lesson_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'ctemawp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_lesson_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'ctemawp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'ctemawp' ),
						...
						'active_callback' => 'ctemawp_cac_has_ld_lesson_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_lesson_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'ctemawp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_lesson_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'ctema_ld_lesson_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'ctemawp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_lesson_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'ctema_ld_layout',
						'settings'        => 'ctema_ld_lesson_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'ctemawp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'ctemawp' ),
						),
						'active_callback' => 'ctemawp_cac_has_ld_lesson_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Heading_Control(
					...
					'ctema_lld_styling_course',
					array(
						'label'    => esc_html__( 'Table', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_heading_color',
					array(
						'label'    => esc_html__( 'Heading Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_heading_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_heading_bg_color',
					array(
						'label'    => esc_html__( 'Heading Background Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_heading_bg_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_item_color',
					array(
						'label'    => esc_html__( 'Item Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_item_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_item_hover_color',
					array(
						'label'    => esc_html__( 'Item Hover Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_item_hover_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_complete_color',
					array(
						'label'    => esc_html__( 'Complete Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_complete_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					'ctema_ld_incomplete_color',
					array(
						'label'    => esc_html__( 'Incomplete Color', 'ctemawp' ),
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_incomplete_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new CtemaWP_Customizer_Color_Control(
					...
					array(
						...
						'section'  => 'ctema_ld_styling',
						'settings' => 'ctema_ld_progressbar_color',
						'priority' => 10,
					)
				)
			);
		...
		public static function head_css( $output ) {
			...
			// Course Table.
			$heading_color     = get_theme_mod( 'ctema_ld_heading_color' );
			$heading_bg_color  = get_theme_mod( 'ctema_ld_heading_bg_color' );
			$item_color        = get_theme_mod( 'ctema_ld_item_color' );
			$item_hover_color  = get_theme_mod( 'ctema_ld_item_hover_color' );
			$complete_color    = get_theme_mod( 'ctema_ld_complete_color' );
			$incomplete_color  = get_theme_mod( 'ctema_ld_incomplete_color' );
			$progressbar_color = get_theme_mod( 'ctema_ld_progressbar_color' );

			// Both Sidebars - Global.
			$ld_global_layout         = get_theme_mod( 'ctema_ld_global_layout', 'full-width' );
			$bs_global_content_width  = get_theme_mod( 'ctema_ld_global_both_sidebars_content_width' );
			$bs_global_sidebars_width = get_theme_mod( 'ctema_ld_global_both_sidebars_sidebars_width' );

			// Both Sidebars - Course.
			$ld_course_layout         = get_theme_mod( 'ctema_ld_course_layout', 'left-sidebar' );
			$bs_course_content_width  = get_theme_mod( 'ctema_ld_course_both_sidebars_content_width' );
			$bs_course_sidebars_width = get_theme_mod( 'ctema_ld_course_both_sidebars_sidebars_width' );

			// Both Sidebars - Lesson.
			$ld_lesson_layout         = get_theme_mod( 'ctema_ld_lesson_layout', 'left-sidebar' );
			$bs_lesson_content_width  = get_theme_mod( 'ctema_ld_lesson_both_sidebars_content_width' );
			$bs_lesson_sidebars_width = get_theme_mod( 'ctema_ld_lesson_both_sidebars_sidebars_width' );
...
return new CtemaWP_LearnDash_Customizer();
