...
if ( class_exists( 'WP_Customize_Control' ) && class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 */
	class CtemaWP_Custom_Control extends WP_Customize_Control {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Custom_Section extends WP_Customize_Section {
		protected function get_skyrocket_resource_url() {
			if ( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Image_Checkbox_Custom_Control extends CtemaWP_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Customizer_Buttonset_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Customizer_Radio_Image_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Single_Accordion_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Simple_Notice_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Customizer_Range_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		...
		public function render_content() {
			?>
			<div class="slider-custom-control control-wrap customize-control-ctemawp-slider">
				<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
				...
				<div class="slider ctemawp-slider" slider-min-value="<?php echo ow_esc_attr( @$this->input_attrs['min'] ); ?>" slider-max-value="<?php echo ow_esc_attr( @$this->input_attrs['max'] ); ?>" slider-step-value="<?php echo ow_esc_attr( @$this->input_attrs['step'] ); ?>"></div>
			</div>
			<?php
		}
	}
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Toggle_Switch_Custom_control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Sortable_Repeater_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Dropdown_Select2_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-select2-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'skyrocket-custom-controls-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'skyrocket-select2-js' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'skyrocket-select2-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Dropdown_Posts_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_TinyMCE_Custom_control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Google_Font_Select_Custom_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function render_content() {
			...
			if ( ! empty( $this->fontList ) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'ctemawp' ); ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'ctemawp' ); ?> <italic><?php esc_html_e( 'italic text', 'ctemawp' ); ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'ctemawp' ); ?> <strong><?php esc_html_e( 'bold text', 'ctemawp' ); ?></strong></div>
					<div class="weight-style">
		...
		public function skyrocket_getGoogleFonts( $count = 30 ) {
			...
			$fontFile = CTEMAWP_INC_DIR_URI . 'customizer/assets/inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = CTEMAWP_INC_DIR_URI . 'customizer/assets/inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class CtemaWP_Customizer_Color_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'skyrocket-custom-controls-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
			wp_localize_script( 'skyrocket-custom-controls-js', 'ctemawpLocalize', array( 'colorPalettes' => ctemawp_default_color_palettes() ) );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class CtemaWP_Alpha_Color_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'wp-color-picker' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Customize_Multicheck_Control extends CtemaWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			if ( isset( $this->input_attrs['fullwidth'] ) && $this->input_attrs['fullwidth'] ) {
				 ...
				 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', CTEMAWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class CtemaWP_Upsell_Section extends CtemaWP_Custom_Section {
		/**
		 * The type of control being rendered
		 */
