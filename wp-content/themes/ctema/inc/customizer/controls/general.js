jQuery(document).on('ctemaready', function() {
	...
	$( '.customize-control .responsive-switchers button:not(.ctema-proccessed)' ).on( 'click', function( event ) {
	...
	$( '.wp-full-overlay-footer .devices button:not(.ctema-proccessed)' ).on( 'click', function( event ) {
