<?php
/**
 * Customizer Control: ctemawp-typo.
 *
 ...
 * Typography control
 */
class CtemaWP_Customizer_Typo_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			$this->l10n,
			array(
				'family'      => esc_html__( 'Font Family', 'ctemawp' ),
				'size'        => esc_html__( 'Font Size', 'ctemawp' ),
				'weight'      => esc_html__( 'Font Weight', 'ctemawp' ),
				'style'       => esc_html__( 'Font Style', 'ctemawp' ),
				'transform'   => esc_html__( 'Text Transform', 'ctemawp' ),
				'line_height' => esc_html__( 'Line Height', 'ctemawp' ),
				'spacing'     => esc_html__( 'Letter Spacing', 'ctemawp' ),
			)
		);
	}
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'ctemawp-typo-js', CTEMAWP_INC_DIR_URI . 'customizer/assets/min/js/typo.min.js', array( 'jquery', 'customize-base', 'select2' ), false, true );
		wp_enqueue_style( 'ctemawp-typo', CTEMAWP_INC_DIR_URI . 'customizer/assets/min/css/typo.min.css', null );
	}
		...
		<ul class="ctemawp-typo-wrap">
			...
			<# if ( data.size ) { #>
				<li class="typography-font-size">
					...
					<input type="text" {{{ data.size.link }}} name="{{ data.size.name }}" value="{{ data.size.value }}" placeholder="<?php esc_attr_e( 'px - em - rem', 'ctemawp' ); ?>" />
			...
			<# if ( data.line_height ) { #>
				<li class="typography-line-height">
					...
					<input type="text" {{{ data.line_height.link }}} name="{{ data.line_height.name }}" value="{{ data.line_height.value }}" placeholder="<?php esc_attr_e( 'px - em - rem', 'ctemawp' ); ?>" />
			...
			<# if ( data.spacing ) { #>
				<li class="typography-letter-spacing">
					...
					<input type="text" {{{ data.spacing.link }}} name="{{ data.spacing.name }}" value="{{ data.spacing.value }}" placeholder="<?php esc_attr_e( 'px - em - rem', 'ctemawp' ); ?>" />
