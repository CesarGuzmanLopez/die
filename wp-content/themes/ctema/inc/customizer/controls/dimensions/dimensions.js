var $ = jQuery;
wp.customize.controlConstructor['ctemawp-dimensions'] = wp.customize.Control.extend({
...
$( document ).on( 'click', '.ctemawp-linked',  function() {
...
// Unlinked button
$( document ).on( 'click', '.ctemawp-unlinked',  function() {
