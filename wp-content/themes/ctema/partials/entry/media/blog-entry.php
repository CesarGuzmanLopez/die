...
$be_seo_set = get_theme_mod( 'ctema_enable_be_fimage_alt', false );
...
$be_fimage_alt = ( false === $be_seo_set || ( true === $be_seo_set && ! $fe_img_alt ) ) ? esc_attr( ctemawp_theme_strings( 'owp-string-read-more-article', false ) ) . ' ' . esc_attr( get_the_title() ) : esc_attr( $fe_img_alt );
