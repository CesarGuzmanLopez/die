...
// Heading tag.
$heading = 'h1';
$heading = apply_filters( 'single_ctema_header_5_h_tag', $heading );

// Display meta filter.
$display_sph_meta = true;
$display_sph_meta = apply_filters( 'display_single_ctema_header_5_meta', $display_sph_meta );

?>

<div class="ctema-single-post-header single-post-header-wrap single-header-ctema-5">
