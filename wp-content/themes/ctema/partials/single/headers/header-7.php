...
// Heading tag.
$heading = 'h1';
$heading = apply_filters( 'single_ctema_header_7_h_tag', $heading );

// Display meta filter.
$display_sph_meta = true;
$display_sph_meta = apply_filters( 'display_single_ctema_header_7_meta', $display_sph_meta );
...
<div class="ctema-single-post-header single-header-ctema-7 <?php echo esc_attr( $class ); ?>">
	...
	<?php ctemawp_paint_post_thumbnail( 'full', array( 'name' => 'ctema-sh-7' ) ); ?>
