...
if ( 'dropdown' !== ctemawp_mobile_menu_style()
...
$dropdown_menu_attrs = apply_filters( 'ctemawp_attrs_mobile_dropdown', '' );
...
<div id="mobile-dropdown" class="clr" <?php echo $dropdown_menu_attrs; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	...
	<nav class="<?php echo esc_attr( $classes ); ?>"<?php ctemawp_schema_markup( 'site_navigation' ); ?>>
