...
if ( class_exists( 'Ctema_Sticky_Header' ) ) {
...
do_action( 'ctema_before_header' );

// If transparent header style.
if ( 'transparent' === $header_style
	|| ( 'full_screen' === $header_style && true === get_theme_mod( 'ctema_full_screen_header_transparent', false ) )
...
<header id="site-header" class="<?php echo esc_attr( ctemawp_header_classes() ); ?>" data-height="<?php echo esc_attr( $header_height ); ?>"<?php ctemawp_schema_markup( 'header' ); ?> role="banner">
	...
	if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'header' ) ) {
		...
		if ( 'top' === $header_style ) {
			...
			<div id="site-header-inner" class="clr <?php echo esc_attr( $class ); ?>">
				...
				<?php do_action( 'ctema_header_inner_middle_content' ); ?>
