...
$position  = get_theme_mod( 'ctema_center_header_menu_position', 'centered' );
...
// Right menu.
$right_menu        = apply_filters( 'ctema_main_menu_location', 'main_menu' );
$right_custom_menu = apply_filters( 'ctema_custom_menu', $right_menu );
...
<div id="site-header-inner" class="<?php echo esc_attr( $classes ); ?>">
	...
	<div id="site-navigation-wrap" class="<?php echo esc_attr( $wrap_classes ); ?>">
		...
		<nav id="site-navigation" class="<?php echo esc_attr( $inner_classes ); ?>"<?php ctemawp_schema_markup( 'site_navigation' ); ?> role="navigation">
			...
			<div class="middle-site-logo <?php echo esc_attr( ctemawp_header_logo_classes() ); ?>">
			...
			<ul class="right-menu <?php echo esc_attr( $menu_classes ); ?>">
				...
				if ( has_nav_menu( $right_menu ) ) {
					...
					// WooCommerce cart.
					if ( 'drop_down' === ctemawp_menu_cart_style() ) {
