...
<div id="medium-searchform" class="header-searchform-wrap clr">
	<form  id="medh-search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="header-searchform" aria-label="<?php echo esc_attr( ctemawp_theme_strings( 'owp-string-website-search-form', false ) ); ?>">
		<label for="medh-input"><?php echo esc_html( ctemawp_theme_strings( 'owp-string-medium-header-search-text', false ) ); ?></label>
