...
// Menu position.
$position = get_theme_mod( 'ctema_top_header_menu_position', 'before' );
...
// Search style.
$search = ctemawp_menu_search_style(); ?>
...
<div class="<?php echo esc_attr( ctemawp_top_header_classes() ); ?>">
