...
$products_per_page = get_theme_mod( 'ctema_woo_shop_posts_per_page', '12' );
 ...
 */
$link = apply_filters( 'ctema_num_products_link', $link );
...
<ul class="result-count">
	<li class="view-title"><?php esc_html_e( 'View:', 'ctemawp' ); ?></li>
	...
	<li><a class="view-all<?php if ( $num_prod === 'all' ) echo ' active'; ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link ) ); ?>"><?php esc_html_e( 'All', 'ctemawp' ); ?></a></li>
</ul>
