...
// Classes.
$wrap_classes = array( 'products', 'ctemawp-row', 'clr' );

// List/grid style.
if ( ( ctemawp_is_woo_shop() || ctemawp_is_woo_tax() )
	&& get_theme_mod( 'ctema_woo_grid_list', true )
	&& 'list' === get_theme_mod( 'ctema_woo_catalog_view', 'grid' ) ) {
	$wrap_classes[] = 'list';
} else {
	$wrap_classes[] = 'grid';
}
...
// Responsive columns.
$tablet_columns = get_theme_mod( 'ctema_woocommerce_tablet_shop_columns' );
$mobile_columns = get_theme_mod( 'ctema_woocommerce_mobile_shop_columns' );
