...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message">
		<?php esc_html_e( 'No products in the cart.', 'ctemawp' ); ?>
		...
		<?php
				 ...
				 */
				echo esc_html( apply_filters( 'ctemawp_mini_cart_shop_link', __( 'Add Products', 'ctemawp' ) ) );
			?>
		</a>
	</p>
