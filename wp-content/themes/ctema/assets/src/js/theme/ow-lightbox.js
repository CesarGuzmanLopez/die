class OWLightbox {
  ...
  initSingleImageLightbox = () => {
    document.querySelectorAll(".ctemawp-lightbox")?.forEach((link) => {
    ...
    jQuery(".ctemawp-lightbox").magnificPopup({
      type: "image",
      ...
      ?.forEach((link) => {
        if (!!link.querySelector("img")) {
          ...
          if (
            ...
            link.classList.add("ctemawp-lightbox");
          }
...
ctemawp.owLightbox = new OWLightbox();
