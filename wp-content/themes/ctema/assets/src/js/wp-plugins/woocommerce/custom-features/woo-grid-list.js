...
class WooGridList {
  ...
  #setElements = () => {
    this.#elements = {
      ...this.#elements,
      grid: document.querySelector(".ctemawp-grid-list #ctemawp-grid"),
      list: document.querySelector(".ctemawp-grid-list #ctemawp-list"),
  ...
  #productCarousel = () => {
    if (
      ...
      ctemawp.owSlider.flickity?.forEach((flickity) => {
        flickity.destroy();
      });
    }
