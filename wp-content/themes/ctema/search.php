	...
	<div id="content-wrap" class="container clr">
		...
		<div id="primary" class="content-area clr">
			...
			<div id="content" class="site-content clr">
				...
				<?php
				$logo_search = get_theme_mod( 'ctema_search_logo' );
				if ( ! empty( $logo_search ) ) {
					?>
					<img class="logo-search" src="<?php echo esc_url( $logo_search ); ?>" alt="<?php esc_attr_e( 'Search Logo', 'ctemawp' ); ?>" title="<?php esc_attr_e( 'Search Logo', 'ctemawp' ); ?>" />
				<?php } ?>
