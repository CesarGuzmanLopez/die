...
final class Post_Type_Switcher {
	...
	public function metabox() {
		...
		?><div class="misc-pub-section misc-pub-section-last post-type-switcher">
			<label for="pts_post_type"><?php esc_html_e( 'Tipo de post:', 'post-type-switcher' ); ?></label>
			...
			<?php if ( current_user_can( $cpt_object->cap->publish_posts ) ) : ?>
				...
				<a href="#" id="edit-post-type-switcher" class="hide-if-no-js"><?php esc_html_e( 'Editar ', 'post-type-switcher' ); ?></a>
				<div id="post-type-select">
					...
					<a href="#" id="cancel-post-type-switcher" class="hide-if-no-js"><?php esc_html_e( 'Cancelar', 'post-type-switcher' ); ?></a>
				</div><?php
	...
	public function quick_edit( $column_name = '' ) {
		...
		<div id="pts_quick_edit" class="inline-edit-group wp-clearfix">
			<label class="alignleft">
				<div>
				<span class="title"><?php esc_html_e( 'Tipo de post actual', 'post-type-switcher' ); ?></span>
				</div>
				<?php
